...
**Protocol definition**: The fields of NATS streaming protocol messages are defined in the nats.go-streaming [protocol file](https://github.com/nats-io/nats.go-streaming/blob/master/pb/protocol.proto).
